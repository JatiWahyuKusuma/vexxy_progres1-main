...
import 'package:vexxy/utils.dart';
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    padding:
                        EdgeInsets.fromLTRB(6 * fem, 6 * fem, 7 * fem, 6 * fem),
                    height: double.infinity,
                    decoration: BoxDecoration(
                      color: Color(0xffffffff),
                      borderRadius: BorderRadius.circular(25 * fem),
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(13 * fem, 0 * fem, 13 * fem, 0 * fem),
              width: double.infinity,
              height: 121 * fem,
              decoration: BoxDecoration(
            ...
            Container(
              // categorypaC (102:6)
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 271 * fem, 16 * fem),
              child: Text(
                'Category',
                style: SafeGoogleFont(
                  'Poppins',
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(40 * fem, 0 * fem, 39 * fem, 32 * fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(22 * fem, 7 * fem, 23 * fem, 7 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
                color: Color(0xffffffff),
